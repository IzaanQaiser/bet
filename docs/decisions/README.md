...
| [0003](0003-credential-scoping-by-iam.md) | Write-scope isolation enforced by IAM, not by convention |
...
| [0009](0009-tentative-placeholder-write-before-confirm.md) | Tentative Calendar placeholders stay tagged/reversible and preserve the single-writer boundary |
